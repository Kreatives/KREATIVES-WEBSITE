...
export const posts: Post[] = [
  ...
  },
  {
    ...
    title: "AI-website laten maken: kosten en valkuilen",
    excerpt:
  ...
  {
    slug: "ai-website-herkennen-en-fixen",
    title: "Website met AI gemaakt? 10 signalen die je verraden",
    excerpt:
      "Sinds 2025 bouwt iedereen in een middag een site, en ze lijken allemaal op elkaar. Dit zijn de tien signalen die verraden dat jouw site door AI is gemaakt, plus hoe je ze oplost.",
    date: "2026-07-16",
    readingMinutes: 8,
    image: "/blog/ai-website-herkennen-en-fixen.webp",
    tags: ["AI", "Webdesign"],
    body: [
      "> **TL;DR:** Je herkent een AI-website aan een handvol terugkerende patronen: staccato-zinnen achter elkaar, de standaard paars-blauwe gradient, dropshadows op elk kaartje en overal dezelfde drie icoontjes naast elkaar. De eerste negen signalen fix je vaak binnen een avond met een paar gerichte aanpassingen. Het tiende signaal, het ontbreken van een CMS en een doordachte structuur, kost meer werk omdat het om keuzes vooraf gaat. Loop hieronder je eigen site langs de tien punten en tel hoeveel je er herkent.",
      "Sinds 2025 kan iedereen in een middag een website in elkaar zetten. Dat is op zich fijn, want de drempel om online te gaan is nog nooit zo laag geweest. Het nadeel merk je pas als je goed kijkt: al die sites lijken op elkaar. Dezelfde zinnetjes, dezelfde kleuren, dezelfde opbouw. En je bezoekers beginnen het te herkennen, ook al kunnen ze niet altijd benoemen wat er precies wringt.",
      "Bij [KREATIVES](/) bouwden we meer dan honderd websites voor Nederlandse ondernemers, en we gebruiken AI daar zelf elke dag bij. AI is dus niet het probleem. Het probleem is dat AI zonder duidelijke sturing telkens dezelfde tien fouten maakt. Hieronder staan ze op een rij, met bij elk punt hoe je het oplost.",
      "## Waarom AI-sites zo op elkaar lijken",
      "Een AI-builder is getraind op miljoenen bestaande websites en kiest daardoor bijna altijd voor het gemiddelde. Het gemiddelde is veilig, maar het valt nergens op. Voeg daar de standaardinstellingen van de tool aan toe, en je krijgt een site die technisch klopt en tegelijk inwisselbaar is voor die van je concurrent. De tien punten hieronder zijn de meest voorkomende verklikkers.",
      "## 1. Staccato-zinnen achter elkaar",
      "AI is dol op korte zinnen op een rij. Denk aan koppen als 'Strak. Snel. Af.' of 'Jouw merk. Jouw verhaal. Jouw site.' Zo praat geen enkele ondernemer aan tafel, en je bezoeker voelt dat meteen. Eén korte zin voor de nadruk werkt prima. Drie op een rij is een trucje dat inmiddels op tienduizenden sites staat. Schrijf in plaats daarvan volle, natuurlijke zinnen zoals je ze hardop tegen een klant zou zeggen.",
      "## 2. De 'niet dit, wel dat'-zin",
      "Dit is de grootste verklikker van allemaal. Formuleringen in de trant van 'geen template, wel maatwerk' of 'niet zomaar een site, wel een merk' staan tegenwoordig op ontelbare Nederlandse websites. Zodra een lezer dat contrastpatroon herkent, daalt zijn vertrouwen in de rest van je tekst. Herschrijf elke zin die zo is opgebouwd naar een directe uitspraak die gewoon vertelt wat je wél biedt, bijvoorbeeld 'Een website die rond jouw aanbod is opgebouwd.'",
      "## 3. De gigantische kop bovenaan",
      "AI-tools zetten standaard een enorme titel van tachtig tot honderdtwintig pixels boven aan de pagina, vaak over de volle breedte. Op het eerste gezicht oogt dat indrukwekkend, maar het duwt je echte informatie onder de vouw en het komt luid over. Merken die je zelf vertrouwt, schreeuwen zelden. Verklein je H1 naar ongeveer 48 tot 56 pixels op desktop en 32 tot 36 pixels op mobiel, en zorg dat de bezoeker naast de kop ook de subtekst en een knop ziet zonder te scrollen.",
      "## 4. Nietszeggende tussenkoppen",
      "'Waarom kiezen voor ons?' 'Onze aanpak: van visie naar realiteit.' 'Klaar om te groeien?' Dit soort koppen zegt niets en plakt AI in vrijwel elke sectie. Een goede tussenkop vertelt de lezer concreet wat hij in dat blok te weten komt. Vervang vraagkoppen en abstracte beloftes door koppen die de inhoud benoemen. 'Wat een website bij ons kost' werkt beter dan 'Klaar om te groeien?'.",
      "## 5. Gedachtestreepjes overal",
      "Kijk eens naar je lopende tekst. Zie je overal van die lange liggende streepjes midden in de zin staan? Dat is een van de duidelijkste vingerafdrukken van AI-tekst. De meeste Nederlandse ondernemers schrijven van nature niet zo. Een komma of een punt doet precies hetzelfde werk zonder je tekst te verraden.",
      "## 6. Dropshadows op alles",
      "Bij een AI-site zweeft elk kaartje, elke knop en elk plaatje net iets boven de achtergrond met een grijze gloed eronder. Schaduw is voor de tool de standaardoplossing voor 'maak het mooi'. Het resultaat voelt druk en een beetje goedkoop aan. Sterke sites gebruiken schaduw bijna nergens, en waar wel, zo subtiel dat je hem niet bewust opmerkt. Haal de zware schaduwen weg en scheid secties voortaan met ruimte, achtergrondkleur of een dunne rand.",
      "## 7. De paars-blauwe gradient",
      "Als je hero, je knoppen of je icoontjes een verloop van paars naar blauw hebben, weet elke designer binnen een seconde met welke tool je site is gebouwd. Het is het standaard kleurenschema van bijna elke AI-builder. Jouw merk verdient een eigen palet in plaats van de fabrieksinstelling. Kies één hoofdkleur, één donkere kleur voor tekst, één lichte achtergrondkleur en hooguit één accentkleur, en pas dat consequent toe op je knoppen, links en accenten.",
      "## 8. Emoji's als design-element",
      "Vinkjes, raketjes en vlammetjes in koppen en opsommingen horen thuis in een appje, niet op een zakelijke website. Het is de snelste manier om van professioneel naar amateuristisch te gaan. Heb je iconen nodig, gebruik dan een strakke set in één stijl en één kleur die bij je palet past. Waar geen icoon nodig is, laat je de tekst voor zichzelf spreken.",
      "## 9. De drie kaartjes naast elkaar",
      "Icoontje, kopje, twee regels tekst, drie keer naast elkaar. AI grijpt naar dit blok voor elk soort informatie, of het nu past of niet. Zo zien jouw diensten, je voordelen en je werkwijze er precies zo uit als die van je concurrent. Hier bestaat geen snelle prompt voor, want de oplossing is een keuze. Welke informatie verdient een groot beeld, welke een opsomming en welke een quote van een klant? Dat heet layout, en precies daar houdt een template op en begint ontwerp.",
      "## 10. Geen CMS en geen strategie",
      "Dit is de fout die je niet ziet, en daarom de duurste. Een AI-builder geeft je een pagina, geen systeem. Er is vaak geen CMS om zelf teksten aan te passen zonder dat er iets breekt. Er zit geen structuur achter die is bedacht vanuit wat jouw klant nodig heeft om te beslissen. En er is geen plan voor vindbaarheid of een logische reden waarom sectie drie op sectie twee volgt. De eerste negen punten prompt je er vanavond nog uit. Dit tiende punt niet. Een goede structuur komt niet uit een tekstvak. Die komt van iemand die vaak genoeg heeft gezien wat werkt voor bedrijven zoals dat van jou. Meer daarover lees je in onze gids over een [AI-website laten maken](/blog/ai-website-laten-maken).",
      "## Je site in één avond een stuk beter maken",
      "Loop de eerste negen punten van boven naar beneden langs en pak ze één voor één op. Begin bij de tekst, want daar zit de meeste winst: haal het staccato-ritme en de contrastzinnen eruit en schrijf zoals je praat. Verklein daarna je kop, ruim de schaduwen op en vervang de standaard gradient door je eigen kleuren. In een paar uur ziet je site er al rustiger en eigener uit.",
      "Het tiende punt vraagt meer. Wil je dat je site niet alleen beter oogt maar ook echt klanten oplevert, dan helpt het om de structuur en de strategie er goed onder te leggen. Daar kijken we bij [maatwerk webdesign](/diensten/webdesign) en in een [gratis blueprint-sessie](/blauwdruk) samen met je naar.",
      "## Veelgestelde vragen over AI-websites",
      "### Kun je zien of een website door AI is gemaakt?",
      "Vaak wel. Let op staccato-zinnen, contrastformuleringen, een enorme kop, dropshadows op alles en een paars-blauwe gradient. Eén zo'n signaal zegt weinig, maar zodra je er drie of meer op één site ziet, is de kans groot dat er weinig sturing aan te pas is gekomen.",
      "### Is een website met AI maken slecht?",
      "Nee. AI is een prima hulpmiddel en wij gebruiken het zelf dagelijks. Het gaat mis wanneer je de standaarduitkomst laat staan, want dan krijg je een site die op duizenden andere lijkt. Met goede sturing en eigen keuzes haal je er juist veel uit.",
      "### Hoe maak ik mijn AI-website professioneler?",
      "Begin bij de tekst en het kleurgebruik, want daar zit de snelste winst. Schrijf natuurlijke zinnen, kies een eigen palet, verklein je kop en haal overbodige schaduwen en emoji's weg. Werk daarna aan de structuur en zorg voor een CMS waarmee je zelf kunt bijwerken.",
      "### Moet ik mijn site helemaal opnieuw laten bouwen?",
      "Niet altijd. Als de basis klopt, kom je met de aanpassingen hierboven al een heel eind. Merk je dat de opbouw niet aansluit op je aanbod of dat je niets zelf kunt wijzigen, dan is een doordachte herbouw meestal verstandiger dan eindeloos blijven bijschaven. In [onze cases](/projecten) zie je het verschil dat dat maakt.",
      "Wil je weten hoe jouw site scoort op deze tien punten? [Stuur ons een bericht](/contact) of plan een [gratis blueprint-sessie](/blauwdruk). We lopen je website met je langs deze punten en vertellen je precies wat we zouden aanpakken, en in welke volgorde.",
    ],
  },
  {
    slug: "website-laten-maken-kinderopvang",
    title: "Website laten maken voor kinderopvang: complete gids",
    excerpt:
      "Wat hoort er op de website van een kinderopvang, wat kost het en hoe zorg je voor meer aanmeldingen? Een complete gids voor kinderdagverblijven, BSO's en gastouders.",
    date: "2026-07-16",
    readingMinutes: 8,
    image: "/blog/website-laten-maken-kinderopvang.webp",
    tags: ["Kinderopvang", "Webdesign"],
    body: [
      "> **TL;DR:** Een goede website voor je kinderopvang doet drie dingen: ouders vertrouwen geven, hun praktische vragen beantwoorden en aanmelden makkelijk maken. Reken voor een professionele kinderopvangsite op grofweg 2.000 tot 6.000 euro, afhankelijk van het aantal locaties en koppelingen zoals een rekentool of ouderportaal. Hieronder lees je precies welke pagina's erop horen, wat het kost en hoe je meer aanmeldingen uit je site haalt.",
      "Voor ouders is de keuze voor een kinderopvang een van de spannendste beslissingen die ze nemen. Ze vertrouwen je het belangrijkste toe dat ze hebben. Bijna al die ouders oriënteren zich eerst online, vaak 's avonds op de bank met hun telefoon. Wat ze op je website zien, bepaalt voor een groot deel of ze een rondleiding aanvragen of doorklikken naar de opvang verderop.",
      "Toch hebben veel kinderdagverblijven, BSO's en gastouders nog een website die blijft steken bij een logo, een paar foto's en een contactformulier. Dat is zonde, want juist in deze branche is vertrouwen alles, en een sterke site bouwt dat vertrouwen op nog voordat een ouder heeft gebeld. In deze gids lees je hoe je dat aanpakt.",
      "## Waarom je kinderopvang een sterke website nodig heeft",
      "De wachtlijsten in de kinderopvang schommelen per regio en per jaar. Het ene moment zit je vol, het andere moment heb je juist plekken in te vullen. Een website die het hele jaar door aanmeldingen binnenhaalt, geeft je rust en voorspelbaarheid. Daarnaast is je site het eerste wat ouders van je zien, ruim voordat ze de sfeer op locatie proeven.",
      "Er speelt ook een praktische kant. Ouders willen snel weten of je opvang bij hun situatie past: de openingstijden, de locatie, de kosten en de pedagogische aanpak. Beantwoordt je site die vragen niet, dan bellen ze vaak niet voor meer informatie maar haken ze af. Elke onbeantwoorde vraag is een gemiste aanmelding.",
      "## Welke pagina's een kinderopvangwebsite nodig heeft",
      "Een kinderopvangsite hoeft niet groot te zijn, maar de belangrijkste onderdelen moeten er wel op staan. Dit is de basis die we voor opvangorganisaties aanraden:",
      "- Een heldere homepage die meteen laat zien wie je bent, waar je zit en voor welke leeftijden\n- Een pagina per opvangvorm, zoals kinderdagverblijf, BSO, peuteropvang of gastouderopvang\n- Een pagina over je pedagogisch beleid en je visie op opvang\n- Een tarievenpagina met een rekentool voor de netto opvangkosten\n- Een teampagina met foto's en namen van de pedagogisch medewerkers\n- Een aanmeld- of rondleidingspagina met een kort, duidelijk formulier\n- Een pagina met veelgestelde vragen",
      "Je hoeft niet met alles tegelijk te beginnen. Zorg eerst dat de homepage, de opvangvormen en het aanmelden staan, en bouw de rest daarna rustig uit.",
      "## De rekentool: laat ouders hun kosten zien",
      "De kosten van kinderopvang zijn voor veel ouders ondoorzichtig door de kinderopvangtoeslag. Een rekentool die de netto opvangkosten laat zien, is daarom een van de meest gewaardeerde onderdelen van een kinderopvangsite. Ouders die vooraf zien wat ze ongeveer kwijt zijn, nemen sneller de volgende stap.",
      "Zo'n tool haalt bovendien de telefoontjes weg die anders over prijs zouden gaan, zodat jij de gesprekken overhoudt die echt over een aanmelding gaan.",
      "## Vertrouwen uitstralen met beeld en verhalen",
      "In de kinderopvang koopt niemand op basis van tekst alleen. Ouders willen voelen dat hun kind bij jou in goede handen is. Echte foto's van je locatie, je ruimtes en je team doen daarvoor meer dan welke slogan ook. Laat de sfeer zien: de speelhoek, de buitenruimte, een medewerker die met kinderen bezig is.",
      "Versterk dat met korte verhalen van andere ouders en met de dingen die vertrouwen geven in jouw vak, zoals je inschrijving in het Landelijk Register Kinderopvang, je GGD-inspectierapport en je pedagogisch beleid. Verstop die informatie niet in een hoekje. Geef ze een duidelijke plek op de site.",
      "## Zorg dat ouders je vinden: lokale SEO",
      "De meeste ouders zoeken lokaal. Ze typen bijvoorbeeld 'kinderopvang' met de naam van hun woonplaats of wijk erbij, of ze zoeken specifiek op 'BSO' of 'gastouder' in de buurt. Om daarop gevonden te worden, helpt het als je website per locatie een eigen pagina heeft met de plaatsnaam in de tekst, de titel en het adres.",
      "Een goed ingevuld Google-bedrijfsprofiel met foto's, openingstijden en reviews versterkt dat nog eens. Voor veel opvangorganisaties levert lokale vindbaarheid meer op dan welke advertentie ook, omdat je precies de ouders bereikt die in jouw omgeving een plek zoeken. Dezelfde principes lees je terug in onze uitleg over [lokaal webdesign](/blog/webdesign-arnhem).",
      "## Wat kost een website voor een kinderopvang?",
      "De prijs hangt vooral af van het aantal locaties, de hoeveelheid pagina's en de koppelingen die je wilt, zoals een rekentool of een ouderportaal. Dit zijn de richtprijzen die we in de markt zien:",
      "| Type site | Indicatieve prijs | Voor wie |\n| --- | --- | --- |\n| Eenvoudige site, één locatie | 1.500 tot 3.000 euro | Gastouder of kleine opvang |\n| Complete site, meerdere opvangvormen | 3.000 tot 6.000 euro | Kinderdagverblijf of BSO |\n| Site met koppelingen en portaal | 6.000 euro en meer | Grotere organisaties |",
      "Reken naast de eenmalige bouwkosten op terugkerende kosten voor hosting, domein en onderhoud. Een uitgebreide uitleg staat in onze gids over [wat een website laten maken kost](/blog/wat-kost-een-website-laten-maken-in-2026).",
      "## Waar je op let bij het kiezen van een bouwer",
      "Kies bij voorkeur iemand die begrijpt hoe ouders kiezen en hoe de kinderopvang werkt, want dat scheelt veel uitleg. Let er daarnaast op dat je een CMS krijgt waarmee je zelf tarieven, teksten en foto's kunt bijwerken, want in de opvang verandert er genoeg gedurende het jaar. Vraag ten slotte naar voorbeelden en naar de manier waarop de site aanmeldingen binnenhaalt, en niet alleen naar hoe hij eruitziet.",
      "## Veelgestelde vragen over een website voor kinderopvang",
      "### Wat kost een website voor een kinderopvang?",
      "Voor een eenvoudige site met één locatie reken je grofweg op 1.500 tot 3.000 euro. Een complete site met meerdere opvangvormen zit meestal tussen de 3.000 en 6.000 euro. Grotere organisaties met koppelingen en een ouderportaal zitten daarboven. De uiteindelijke prijs hangt af van de omvang en de gewenste techniek.",
      "### Welke pagina's heeft een kinderopvangwebsite nodig?",
      "In de basis: een homepage, een pagina per opvangvorm, een pagina over je pedagogisch beleid, een tarievenpagina met rekentool, een teampagina, een aanmeldpagina en een pagina met veelgestelde vragen. Begin met de belangrijkste en bouw de rest daarna uit.",
      "### Hoe krijg ik meer aanmeldingen via mijn website?",
      "Zorg dat ouders hun vragen beantwoord krijgen en dat aanmelden makkelijk is. Laat echte foto's zien, toon je tarieven met een rekentool, plaats ervaringen van andere ouders en maak het aanvragen van een rondleiding met een kort formulier zo eenvoudig mogelijk. Zorg daarnaast dat je lokaal goed vindbaar bent.",
      "### Kan ik een rekentool voor de opvangkosten toevoegen?",
      "Ja. Een rekentool die de netto kosten na kinderopvangtoeslag laat zien, is een van de meest gewaardeerde onderdelen van een kinderopvangsite. Het geeft ouders duidelijkheid en scheelt jou vragen over prijs.",
      "Wil je een website die het hele jaar door aanmeldingen oplevert voor je kinderopvang? [Neem contact met ons op](/contact) of plan een [gratis blueprint-sessie](/blauwdruk). We denken graag met je mee over de opzet, de teksten en de vindbaarheid, en laten je zien wat er voor jouw opvang mogelijk is.",
    ],
  },
];
